...
public class AAChestBoatEntity extends AABoatEntity implements HasCustomInventoryScreen, ContainerEntity {
    private NonNullList<ItemStack> inventory = NonNullList.withSize(27, ItemStack.EMPTY);
    @Nullable
    private ResourceLocation lootTableId;
    private long lootTableSeed;

    public AAChestBoatEntity(EntityType<? extends AAChestBoatEntity> entityType, Level world) {
        super(entityType, world);
    }

    public AAChestBoatEntity(Level world, double d, double e, double f) {
        this(AAEntityTypes.CHEST_BOAT.get(), world);
        this.setPos(d, e, f);
        this.xo = d;
        this.yo = e;
        this.zo = f;
    ...
    public Item getDropItem() {
        return this.getAABoatType() == BoatType.ASH ? AAItems.ASH_CHEST_BOAT.get() : AAItems.GOURDROT_CHEST_BOAT.get();
    }
