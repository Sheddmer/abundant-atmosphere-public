...
public class PoreshroomBlock extends BushBlock implements BonemealableBlock {
    ...
    public PoreshroomBlock(BlockBehaviour.Properties p_153983_, Supplier<Holder<? extends ConfiguredFeature<?, ?>>> p_153984_) {
        super(p_153983_);
